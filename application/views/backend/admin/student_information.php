                ...
                <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th><div><?php echo get_phrase('hostel');?></div></th>
                            <th><div><?php echo get_phrase('transport Route');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->db->get_where('transport' , array('transport_id' => $row['transport_id']))->row()->route_name;?></td>
