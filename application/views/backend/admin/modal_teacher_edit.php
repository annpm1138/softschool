		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?admin/teacher/do_update/'.$row['teacher_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('blood group');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="blodgroup" value="<?php echo $row['blodgroup'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Date of Joining');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="datepicker form-control" name="doj" value="<?php echo $row['doj'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Id Card/ILP No.');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="idno" value="<?php echo $row['idno'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Trained/Untrained');?></label>
                                <div class="col-sm-5">
                                    <select name="training" class="form-control selectboxit">
                                    <option value=""><?php echo get_phrase('select');?></option>
                                        <option value="trained" <?php if($row['training'] == 'Trained')echo 'selected';?>><?php echo get_phrase('Trained');?></option>
                                        <option value="untrained" <?php if($row['training'] == 'untrained')echo 'selected';?>><?php echo get_phrase('untrained');?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
