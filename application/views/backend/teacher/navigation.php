...
<?php endforeach; ?>
        ...
        <li class="<?php if ($page_name == 'attendance_report') echo 'opened active'; ?> ">
            ...
            <ul>
                ...
                foreach ($classes as $row):
                    ?>
                    <li class="<?php if ($page_name == 'attendance_report' && $class_id == $row['class_id']) echo 'active'; ?>">
                        <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/attendance_report/<?php echo date("d/m/Y"); ?>/<?php echo $row['class_id']; ?>">
                            <span><?php echo get_phrase('class'); ?> <?php echo $row['name']; ?></span>
                        </a>
                    </li>
                <?php endforeach; ?>
