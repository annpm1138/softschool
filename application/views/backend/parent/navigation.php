<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- ATTENDANCE REPORT-->
        <li class="<?php
        if ($page_name == 'attendance_report') echo 'opened active';?> ">
            <a href="#">
            ...
            ?>
                <li class="<?php if ($page_name == 'attendance_report') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?parents/attendance_report/<?php echo date("d/m/Y"); ?>/<?php echo $row['student_id'];?>">
                        <span><i class="entypo-dot"></i> <?php echo $row['name'];?></span>
                    </a>
                </li>
            <?php endforeach;?>
